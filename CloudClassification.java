...
public class CloudClassification extends RecursiveAction {
  ...
  public CloudClassification (Vector[][][] adv, float[][][] cnv, int[][][] cls, int timeStart, 
  ...
  protected void compute () {
      ...
      for(int s = startStep; s < endStep; s++){
        for(int a = fromRow; a < toRow; a++)  {
          for(int b = fromCol; b < toCol; b++){
            // Local average
            float windMagnitude = localAve (advection, s, a, b, toRow, toCol); 
            // Classify
   ...
   private float localAve (Vector[][][] wind, int t, int i, int j, int xDimension, int yDimension) {
